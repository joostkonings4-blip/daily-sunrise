...
// ─── 1. OPENING ───────────────────────────────────────────────────────────────
// Full screen — real sunrise nature photo, logo centred, single tagline
function Opening() {
  ...
  return (
    ...
    >
      {/* Nature photo — parallax only on image, not content */}
      ...
      {/* Content — fades on scroll but does NOT move */}
      <motion.div
...
// ─── 2. THE PAUSE ─────────────────────────────────────────────────────────────
// Dark section — interrupt the scroll with truth
function ThePause() {
  const { ref, visible } = useFade();
  const stats = [
...
// ─── 3. THE FEELING ───────────────────────────────────────────────────────────
// Forest photo left, founder text right
function TheFeeling() {
...
// ─── 5. NATURE BREAK ──────────────────────────────────────────────────────────
// Full-width photo with quote — gentle parallax on image only
...
function TheLetter() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      // silent — user still gets the success state
    }
    setDone(true);
  }
